...
//  friend class XMLNode;
  ...
  public:
    ...
    XMLNode *getChildNodePtr(int i=0);                         // return ith child node
    XMLNode getChildNode(LPCTSTR name, int i);             // return ith child node with specific name
    XMLNode *getChildNodePtr(LPCTSTR name, int i);             // return ith child node with specific name
                                                           //     (return an empty node if failing)
    XMLNode *getChildNodePtr(LPCTSTR name, int *i=NULL);       // return next child node with specific name
