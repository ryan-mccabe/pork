...
static const struct pork_pref irc_pref_list[] = {
	{	.name = "AUTOSAVE",
		...
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format,
	},{	.name = "FORMAT_WHOIS_CHANNELS",
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format,
	},{	.name = "FORMAT_WHOIS_IDLE",
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format
	},{	.name = "FORMAT_WHOIS_IRCNAME",
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format,
	},{	.name = "FORMAT_WHOIS_NICK",
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format,
	},{	.name = "FORMAT_WHOIS_OPERATOR",
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format,
	},{	.name = "FORMAT_WHOIS_SERVER",
		.type = OPT_TYPE_FORMAT,
		.set = opt_set_format,
...
static pref_val_t irc_default_pref_vals[] = {
	...
	},{	.pref_val.s = DEFAULT_IRC_FORMAT_CHAT_MODE,
