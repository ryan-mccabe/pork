...
double transfer_avg_speed(struct file_transfer *xfer);
char *transfer_get_local_hostname(struct file_transfer *xfer);
char *transfer_get_remote_hostname(struct file_transfer *xfer);
